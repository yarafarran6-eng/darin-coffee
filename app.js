...
document.addEventListener('click', (e)=>{
  ...
  switch(a){
    ...
    case 'save-product': {
      ...
      closeModal(); render(); showToast(state.lang==='ar'?'تم حفظ المنتج':'Product saved'); break;
    }
    ...
    case 'delete-product': {
      ...
      closeModal(); state.page='home'; render(); showToast(state.lang==='ar'?'تم حذف المنتج':'Product deleted'); break;
    }
    ...
    case 'approve-product': {
      ...
      render(); showToast(state.lang==='ar'?'تم النشر':'Published'); break;
    }
    case 'reject-product': {
      const p = DB.pendingProducts.splice(parseInt(t_.dataset.i),1)[0];
